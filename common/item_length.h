...
enum EItemMisc
{
	...
	CRAFTING_MATERIAL_MAX_NUM	= 10,

	QUEST_REWARD_MAX_ITEMS = 6,
	QUEST_REWARD_MAX_QUEST_NAME_LEN = 64,
...
enum EDSInventoryMaxNum
{
	...
	DS_REFINE_WINDOW_MAX_NUM = 15, // from client
};
...
enum ETuningItemBonusFlag
{
	TUNING_FLAG_100_CHANCE = (1 << 0),
	TUNING_FLAG_NO_GOLD = (1 << 1),
	TUNING_FLAG_NO_ITEM = (1 << 2),
};

enum EBonusRefineItemTypes
{
	REFINE_BONUS_ITEM_ALL,
	REFINE_BONUS_ITEM_ARMOR,
	REFINE_BONUS_ITEM_WEAPON,
	REFINE_BONUS_ITEM_JEWELRY,
};

enum enum_RefineScrolls
{
	NORMAL_REFINE_SCROLL,
	NO_REDUCTION_WHEN_FAIL_SCROLL,
	UP_TO_3TH_LEVEL_SCROLL,
	REFINE_BONUS_SCROLL,
};
...
enum ERefineType
{
	...
	REFINE_TYPE_SCROLL,
	REFINE_TYPE_NO_REDUCTION_WHEN_FAIL,
	REFINE_TYPE_MONEY_ONLY,
	REFINE_TYPE_UP_TO_3TH_LEVEL,
	REFINE_TYPE_BDRAGON, // UNUSED
	REFINE_TYPE_FISHER,
	REFINE_TYPE_HERB_KNIFE,
	REFINE_TYPE_PICKAXE,
	REFINE_TYPE_MAX,
};
