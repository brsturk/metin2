...
int main(int argc, char **argv)
{
	...
	CCraftingManager		crafting_manager;
	CNameReservationManager	name_reservation_manager;
	CEventHelperManager	event_helper_manager;
	SpecialSpawnManager special_spawn_manager;
	CSpecialShopManager special_shop_manager;
