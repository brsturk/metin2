...
class CItem : public CEntity
{
	...
	public:
		...
		bool		SetCount(ITEM_COUNT count);
		ITEM_COUNT		GetCount();
		...
		DWORD		GetMaxStack() const { return m_pProto ? m_pProto->dwMaxStack : ITEM_MAX_COUNT; }
		...
		void		SetSocket(int i, long v, bool bLog = true, const char* logHint="SOCKET");
