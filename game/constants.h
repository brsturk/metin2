...
typedef struct OfflineShopTimeConfig
{
	YANG price;
	DWORD duration;
	bool isPremium;
...
extern const int aiUniqueApplyWeapon70Types[14];
extern const int aiUniqueApplyWeapon70Values[14][10];
...
extern const OfflineShopTimeConfig			aOfflineShopTime[OFFLINESHOP_TIME_OPTION_MAX];
