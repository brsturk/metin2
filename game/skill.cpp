...
#endif
	{ "TERROR", POINT_TERROR	},
	{ "ATT_GRADE_MOB", POINT_ATT_GRADE_MONSTER	},
	{ "MAGIC_ATT", POINT_MAGIC_ATT	},
	{ "MAGIC_ATT_MOB", POINT_MAGIC_ATT_MONSTER	},
	{ "MAGIC_ATT_GRADE_MOB", POINT_MAGIC_ATT_GRADE_BONUS_MONSTER	},
	{ "RESIST_MOB_1000PCT", POINT_RESIST_MONSTER_1000PCT	},
	{ "ABSORB_DAMAGE_MOB", POINT_ABSORB_DAMAGE_MONSTER	},
	{ "RESIST_PENETRATE", POINT_RESIST_PENETRATE	},
	{ "ATT_SPECIAL", POINT_ATT_SPECIAL	},
	{ "\n",		POINT_NONE		},
};
...
bool CSkillManager::Initialize(TSkillTable * pTab, int iSize)
{
	...
	for (int i = 0; i < iSize; ++i, ++t)
	{
		...
		pkProto->dwAffectFlag3 = t->dwAffectFlag3;
