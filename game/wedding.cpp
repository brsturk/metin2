...
namespace marriage
{
	...
	void WeddingMap::SetEnded()
	{
		...
		if (!canEndWedding)
		{
			Notice(LC_TEXT("Wedding is still ongoing!"));
			Notice(LC_TEXT("One of the wedding quests is not ready to leave the wedding."));
			return;
		}
