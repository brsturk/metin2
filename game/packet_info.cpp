...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_CHECK_VERSION, sizeof(TPacketCGCheckVersion), "CheckClientVersion", true);
	Set(HEADER_CG_REQUEST_INFO_RESPONSE, sizeof(TPacketCGRequestInfoResponse), "RequestInfoResponse", false);
...
CPacketInfoGG::CPacketInfoGG()
{
	...
	Set(HEADER_GG_DISCONNECT_PLAYER_ID, sizeof(TPacketGGDisconnectPlayerId), "DisconnectPlayerId", false);
	Set(HEADER_GG_DISCONNECT_HWID, sizeof(TPacketGGDisconnectHwid), "DisconnectHwid", false);
	...
	Set(HEADER_GG_ITEMSHOP_AUCTION_UPDATE, sizeof(TPacketGGItemShopAuctionUpdate), "ItemShopAuctionUpdate", false);
	Set(HEADER_GG_FIND_DUNGEON, sizeof(TPacketGGDungeonFind), "DungeonFind", false);
	Set(HEADER_GG_MAINTENANCE, sizeof(TPacketGGMaintenance), "Maintenance", false);
	Set(HEADER_GG_DELAYED_SHUTDOWN, sizeof(TPacketGGDelayedShutdown), "DelayedShutdown", false);
	Set(HEADER_GG_BLOCK_MESSENGER, sizeof(TPacketGGBlockMessenger), "BlockMessenger", false);
